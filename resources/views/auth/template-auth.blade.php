...
<html>
<head>
    <title>AppSudahDigital | @yield('title')</title>
    <meta name="description" content="Sudah Digital">
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <meta name="csrf-token" content="{{ csrf_token() }}" />
    <link rel="icon" href="{{ asset('assets/image/Logo_SudahDigital.png')}}" type="image/x-icon">
    <!-- Bootstrap CSS CDN -->
