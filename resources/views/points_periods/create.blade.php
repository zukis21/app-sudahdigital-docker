...
@section('title') Create Point Periods @endsection
@section('content')
    <style>
    ...
    <form id="form_validation" method="POST"  action="{{route('points_periods.store',[$vendor])}}">
        ...
        <div class="form-group form-float">
            <div class="form-line" >
                ...
                value="{{old('name', $PointPeriod->name ?? '')}}"
        ...
        <div class="input-daterange input-group" id="">
            <div class="form-line">
                <input type="text"  name="starts_at" value="{{old('starts_at', $PointPeriod->starts_at ?? '')}}"
                class="start_date form-control" 
                readonly required placeholder="Date start...">
            </div>
            <span class="input-group-addon">to</span>
            <div class="form-line">
                <input type="text" name="expires_at" value="{{old('expires_at', $PointPeriod->expires_at ?? '')}}"
